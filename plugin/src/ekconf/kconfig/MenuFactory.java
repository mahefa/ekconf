...
import ekconf.internal.kconfig.NativeMenu;
...
public class MenuFactory {
	...
	public static Menu newMenu(long pMenu , Menu parent) throws KconfigException
	{
		return NativeMenu.newInstance(pMenu, parent);
	}
}
